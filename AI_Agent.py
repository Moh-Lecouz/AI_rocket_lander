...
class Agent():
    ...
    def __init__(self, state_size, action_size):
        ...
        self.local_qnetwork = neural_network(state_size, action_size).to(self.device)
...
# Initializing the Deep Q-Learning Network Agent
...
###+++++++++++ Launching the agent and Visualizing the results +++++++++++###
